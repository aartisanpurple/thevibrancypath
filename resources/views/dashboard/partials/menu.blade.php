<div class="col-lg-3 mb-4">
        <div class="list-group">
          <a href="{{ route('customer.dashboard') }}" class="list-group-item list-group-item-action active" style="background-color: #8b0078; border-color: #8b0078; color: #fff;">My Account</a>
          ...
          <a href="{{ route('customer.myorder') }}" class="list-group-item list-group-item-action">Favourites</a>
          <a href="{{ route('customer.mymembership') }}" class="list-group-item list-group-item-action">My Subscription</a>
          <a href="{{ route('customer.myorder') }}" class="list-group-item list-group-item-action">My Appointments</a>
        </div>
      </div>