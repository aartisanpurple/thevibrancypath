...
<!-- Hero Section -->
<!-- Hero Section -->
<section id="home" class="hero-section text-center text-white d-flex justify-content-center align-items-start" style="height: 100vh; padding-top: 20vh;">
    <div>
   ...
   <section class="video-section py-lg-5 py-lg-0 pb-5">
            ...
            <div class="swiper mySwiper">
                ...
                <div class="swiper-slide">
                    <div class="card text-center p-4 shadow border-0">
                        <div class="mx-auto" style="width: 120px; height: 120px; border: 5px solid #e3c87c; border-radius: 50%; overflow: hidden;">
    ...
    <a href="#" class="text-decoration-none text-danger fw-semibold d-inline-flex align-items-center gap-2">
